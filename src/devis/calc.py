...
VOLUME_DISCOUNT_THRESHOLD_EUR = 2000.00  # BHV-2 : strictement supérieur (BHV-2a)
...
def compute_quote(products_subtotal_eur: float, surface_m2: float) -> dict:
    ...
    Contrat de sortie = clés des Examples de la spec (design.md §5) :
    products_eur, installation_eur, total_eur, is_estimate.
    """
    # INV-1 : total ≥ 0 quelles que soient les entrées — bornes basses à 0.
