...
4. Placer un CHECKPOINT : après le premier vertical slice de bout en bout, avant toute intégration externe (API internes / SI, données réelles), et avant merge. Jamais plus de 4-5 tâches sans checkpoint.
